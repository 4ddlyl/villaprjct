    ...
    <div class="flex">
        ...
        <div class="flex-1 main-content bg-[#f0f2f5]">
            ...
            <div class="bg-white border-b px-6 py-4 flex items-center justify-between sticky top-0 z-10">
                ...
                <div class="flex items-center gap-4">
                    <div class="relative">
                        <input type="text" placeholder="Cari sesuatu..." class="pl-10 pr-4 py-2 border rounded-lg w-64 focus:outline-none focus:ring-2 focus:ring-[#16614D] focus:border-transparent">
