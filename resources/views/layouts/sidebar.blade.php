<div class="w-[250px] bg-[#16614D] rounded-2xl m-5 mr-0 flex flex-col overflow-hidden shadow-lg">
    ...
    <nav class="flex-1 px-3 space-y-1">
        <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white text-[#16614D] text-sm font-medium">
        ...
        <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-white/80 hover:bg-white/10 text-sm transition">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
