...
<body>
        ...
        <div class="flex-1 overflow-y-auto">
            ...
            <div class="bg-white border-b px-6 py-4 flex items-center justify-between sticky top-0 z-10">
                ...
                <div class="flex items-center gap-4">
                    <!-- Search Bar -->
                    <div class="relative">
                        <input type="text" placeholder="Cari sesuatu..." class="pl-10 pr-4 py-2 border rounded-lg w-64 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="icon-bg bg-yellow-50">
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="icon-bg bg-purple-50">
                ...
                <div class="bg-white rounded-2xl shadow-sm border p-6 mb-6">
                    ...
                    <!-- Highlight Card -->
                    @if(($reservasiPerHari ?? []) && count($reservasiPerHari ?? []) > 0)
                    <div class="bg-gray-50 rounded-xl p-4 mt-6 flex justify-between items-center">
                        <span class="text-gray-600 text-sm">{{ ($reservasiPerHari[array_key_last($reservasiPerHari)]['tanggal'] ?? 'Hari ini') }}</span>
                        <span class="text-gray-800 font-semibold">Reservasi: {{ ($reservasiPerHari[array_key_last($reservasiPerHari)]['jumlah'] ?? 0) }}</span>
                    </div>
                    @endif
                </div>
    ...
    <script>
        ...
        const defaultLabels = ['10 Mei', '11 Mei', '12 Mei', '13 Mei', '14 Mei', '15 Mei', '16 Mei'];
        const defaultValues = [11, 17, 19, 24, 25, 26, 26];
